            ...
            <mat-horizontal-stepper *ngSwitchDefault
                ...
                <ng-template matStepperIcon="number" let-index="index">
                    <ng-container [ngSwitch]="index">
                        <mat-icon class="icon-step" *ngSwitchCase="0">agriculture</mat-icon>
                        <mat-icon class="icon-step" *ngSwitchCase="1">shopping_cart</mat-icon>
                        <mat-icon class="icon-step" *ngSwitchCase="2">local_shipping</mat-icon>
                        <mat-icon class="icon-step" *ngSwitchCase="3">verified</mat-icon>
                    </ng-container>
                </ng-template>
